            ...
            <div className="container pd-6">
                <div className="row">
                    <div className="col s12 center-align">
                        ...
                        <p className="white-text"> Future Fownders is an immersive program encouraging the development of the entrepreneurial mindset, the cultivation of personal growth, and the establishment of a social network of like-minded aspiring youth entrepreneurs. Our Future Fownders are developed through our in-school programming, workshop series, internship program, mentorship and community outreach initiatives.
                            <br/>
                            <br/>
